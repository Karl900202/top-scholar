    ...
    <div className="min-h-screen bg-black pb-safe">
      ...
      <section className="px-4 py-16 text-center relative overflow-hidden">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900/80 backdrop-blur-sm rounded-full border border-gray-800 shadow-sm mb-6">
            <span className="text-xs font-medium text-white">✨ 창의적 아이디어 커뮤니티</span>
          </div>
          ...
          <p className="text-lg text-white leading-relaxed max-w-md mx-auto mb-2">
            창의적으로 해결하는 커뮤니티 플랫폼
          </p>
          <p className="text-base text-gray-300 leading-relaxed max-w-md mx-auto">
            대기업의 공모전부터 개인의 고민까지. 
            <br />
            <span className="text-gray-400">다양한 사람들의 창의적 아이디어로 함께 해결해요.</span>
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-12 relative">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-white">장원이 특별한 이유</h2>
          </div>
          <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
            <p className="text-white leading-relaxed text-base">
              대기업의 공모전부터 개인의 작은 고민까지. 
              <span className="font-semibold text-white">장원</span>은 모든 문제를 창의적으로 해결하는 커뮤니티 플랫폼이에요.
              <br /><br />
              기업은 공모전을 운영하고 다양한 아이디어를 수집하고, 
              개인은 자신의 고민을 공유하고 커뮤니티의 창의적 해결책을 받아볼 수 있어요.
              <br /><br />
              <span className="text-gray-300 italic">아이디어로 급제하는 순간, 여기서 시작됩니다.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300">당신의 목적에 맞게 선택하세요</p>
        </div>
        <div className="space-y-6 max-w-2xl mx-auto">
          {/* 출제자 */}
          <div className="group relative bg-gray-900 rounded-2xl p-6 border border-gray-800 transition-all duration-300">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs px-2 py-1 bg-blue-900/50 text-blue-300 rounded-full font-medium border border-blue-800">
                    기업 / 개인
                  </span>
                </div>
                <p className="text-white leading-relaxed">
                  ...
                  <br /><br />
                  <span className="font-semibold text-white">다양한 사람들의 아이디어를 한눈에 확인하고, 최고의 해결책을 찾아보세요.</span>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs px-2 py-1 bg-emerald-900/50 text-emerald-300 rounded-full font-medium border border-emerald-800">
                    지원자 / 학습자
                  </span>
                </div>
                <p className="text-white leading-relaxed">
                  ...
                  <br /><br />
                  <span className="font-semibold text-white">당신의 창의적 아이디어로 함께 성장하는 커뮤니티에 참여하세요.</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300">다양한 시나리오에서 빛을 발합니다</p>
        </div>
        <div className="space-y-4 max-w-2xl mx-auto">
          <div className="group bg-gray-900 rounded-xl p-6 border border-gray-800 transition-all duration-300">
          ...
          <div className="group bg-gray-900 rounded-xl p-6 border border-gray-800 transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-white mb-1.5 text-lg">커뮤니티 아이디어 수집</h3>
                <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gray-900 rounded-xl p-6 border border-gray-800 transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-white mb-1.5 text-lg">개인 고민 해결</h3>
                <p className="text-sm text-gray-300 leading-relaxed">
      ...
      <section className="px-4 py-12 pb-10 text-center relative">
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <p className="text-gray-300 mb-10 leading-relaxed">
            지금 바로 시작해서<br />
            <span className="text-gray-400">당신만의 평가 여정을 만들어보세요</span>
          </p>
        </div>
      </section>
      ...
      {/* Floating Button */}
      <div
        className="bg-black fixed w-full max-w-md bottom-0 left-1/2 -translate-x-1/2 z-50"
      >
        <Link
          href="/main"
          className="w-full p-5 text-white font-semibold active:scale-[0.98] transition-all duration-200 min-h-[52px] border-t border-gray-800 flex items-center justify-center"
        >
